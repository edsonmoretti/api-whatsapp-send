...
{{--                    </div>--}}
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card card-mini  mb-4">
                <div class="card-body">
                    <h2 class="mb-1">{{ $messagesSentToday }}</h2>
                    <p>Mensagens enviadas hoje</p>
{{--                    <div class="chartjs-wrapper">--}}
...
{{--                    </div>--}}
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card card-mini mb-4">
                <div class="card-body">
                    <h2 class="mb-1">{{ $invalidNumberMessages }}</h2>
                    <p>Mensagens com número inválido</p>
{{--                    <div class="chartjs-wrapper">--}}
...
{{--                    </div>--}}
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card card-mini mb-4">
                <div class="card-body">
                    <h2 class="mb-1">{{ $messagesYear }}</h2>
                    <p>Mensagens enviadas neste ano.</p>
{{--                    <div class="chartjs-wrapper">--}}
