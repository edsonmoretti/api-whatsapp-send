...
<head>
    <head>
        ...
        <!-- SLEEK CSS -->
        <link id="sleek-css" rel="stylesheet" href="{{ asset('assets/css/styles.css') }}"/>
                    ...
                    <form method="POST" action="{{ route('auth') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 mb-4">
                                <input type="text" class="form-control input-lg @error('cpf') is-invalid @enderror"
                                       name="cpf" id="cpf"
                                       aria-describedby="emailHelp" placeholder="CPF">
                                @error('cpf')
                            ...
                            <div class="col-md-12">
                                <div class="d-flex my-2 justify-content-between">
                                    <div class="d-inline-block mr-3">
                                        <label class="control control-checkbox">Relembrar
                                    ...
                                    @if (Route::has('password.request'))
                                        <p><a class="text-blue" href="#">Esqueceu sua senha?</a></p>
                                    @endif
                                </div>
